#!/usr/bin/env node
/**
 * Pruebas de «partir el dinero de una factura por tienda» (ADR-0184, F2) contra el Postgres local — CAYLA V2.
 *
...
// La vista ya está aplicada (20260923180100, junto con las demás de ADR-0184); se vuelve a cargar dentro de cada caso para
...
// ADR-0161 + ADR-0184: QUIÉN = un módulo de Compras en el rol (aquí, «integrante», el de Micaela); DÓNDE = su tienda
