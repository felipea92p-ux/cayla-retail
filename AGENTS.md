...
Este archivo define cómo Codex debe operar en este repo. Fundador: Felipe Alvarez.
...
en `~/.Codex/AGENTS.md` — es global a todos los proyectos de Felipe, no se repite
