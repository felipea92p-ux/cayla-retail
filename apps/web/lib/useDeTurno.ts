...
export type DeTurno = {
  ...
  fallo: boolean;
  /** La lista viene de la memoria de este navegador (pantalla abierta sin red, ADR-0207): la hora de esa lectura. */
 ...
 *
 * Memoria (ADR-0207): cada lectura buena se guarda en este navegador, por sede. Una pantalla que se ABRE sin red
