...
export async function guardarEjesCategoria(categoriaId: string, ejes: EjeIds, tallaHabitualIds?: string[]): Promise<string | null> {
  try {
...
export async function proponerValorVocabulario(tipo: TipoVocabulario, texto: string): Promise<{ valor: ValorCreado | null; error: string | null }> {
  try {
