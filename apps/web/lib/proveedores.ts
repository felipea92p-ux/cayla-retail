...
export type Proveedor = {
   ...
   * facturas_con_recepcion_pendiente, facturas_atrasadas, y desde ADR-0104
...
// Las cifras de la cabecera de la lista (ADR-0104): activos, deuda total con proveedores,
...
//
// Los promedios llegan CON su muestra (ADR-0104): «11 días» de una sola entrega no es una tendencia, y
