...
/**
 * El trío de sincronización de la cola sin conexión (ADR-0210), el mismo de la venta (ADR-0063) pero reutilizable:
...
export function useColaOffline(
  ...
  opciones: {
    ...
    /** Al final de cada pasada, haya o no cola: trabajo que cuelga de lo ya subido (las fotos de un alta, ADR-0210). */
