...
import { FranjaProformas } from "@/components/FranjaProformas";
...
export default async function ResumenPage() {
  ...
  // Las proformas vigentes también: la franja dice que no pudo leerlas.
  //
  ...
  const [ventasHoy, comprobantesHoy, porEnviar, referencia, proformas] = await Promise.all([
    getVentasDeHoy(),
    ...
    opcional(getResumenProformas(), "las proformas vigentes (Resumen)"),
  ]);
  ...
  return (
    <div className="space-y-6">
      ...
      <FranjaProformas resumen={proformas} />
