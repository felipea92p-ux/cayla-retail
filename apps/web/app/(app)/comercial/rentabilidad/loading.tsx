// Esqueleto de carga de Rentabilidad (ADR-0118). Misma receta que comercial/calidad/loading.tsx: la silueta —título, fila de
// cuatro tarjetas y una tabla— evita el salto de "pantalla vacía → todo de golpe" mientras corre la función de agregación.
export default function LoadingRentabilidad() {
  return (
    <div className="animate-pulse space-y-6" aria-busy="true" aria-label="Cargando la rentabilidad">
