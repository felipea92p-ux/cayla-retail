import { accionesDeCompraDe, exigirModulo } from "@/lib/persona-actual";
...
export default async function NotasCreditoPage() {
  const persona = await exigirModulo("notas_credito"); // 20260923130000: la puerta del módulo Notas de crédito
  ...
  return (
    <NotasCreditoPanel
      ...
      falla={tablero.falla}
      hoy={hoyLima()}
      puedeReembolsar={accionesDeCompraDe(persona).pagar}
    />
  );
}
