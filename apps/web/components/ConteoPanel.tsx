      ...
      <div className="space-y-4">
        <div className="card-cayla space-y-3 p-6 text-center">
          ...
          {separaPisoAlmacen ? (
            ...
            <button type="button" onClick={() => abrir(null)} disabled={abriendo !== null || !responsable.listo} title={responsable.motivo ?? undefined} className="btn-cayla btn-primario mx-auto px-6">
