...
/**
 * Con la caja cerrada (ADR-0183): cuánto quedó en el cajón, quién cerró, si cuadró y a dónde se fue el resto. Es el
 * contexto de «Antes de abrir, cuenta el cajón». Los cierres anteriores a ADR-0183 no guardaron el fondo: se muestra
