...
/** La cabecera de Cambios y de Devoluciones (Atelier, 2026-09-19): arriba, dónde y cuándo
...
export function EncabezadoPagina({ sede, titulo, subtitulo, children }: { sede: string; titulo: string; subtitulo: string; children?: ReactNode }) {
  return (
