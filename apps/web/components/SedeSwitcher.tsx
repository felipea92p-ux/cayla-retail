...
export function SedeSwitcher({
  ...
  return (
    <select
      ...
      className="label-cayla cursor-pointer card-cayla px-2 py-1.5 text-[11px] text-tinta outline-none transition-colors hover:border-rojo focus:border-rojo disabled:opacity-50"
