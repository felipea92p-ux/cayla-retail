...
export interface HighlightSegmentProps {
  /** The rendered base stroke's `d` — re-used verbatim. Sourced from the same
   * `usePathStrokeMetrics` state the base `<path>` renders from (not read off
   * a ref during render — refs can't be read during the render phase). */
  pathD: string | null;
