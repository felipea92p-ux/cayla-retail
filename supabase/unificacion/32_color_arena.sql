-- ============================================================================
-- 32 — Arena entra al vocabulario de colores
-- Correr en cayla-DYNAMIC (SQL Editor). Gemelo de `supabase/migrations/0050_color_arena.sql`.
--
-- POR QUÉ
--   Al pegar `28_colores.sql` en producción, 5 de las 19 variantes quedaron
...
--   `28` y `29`, sin nombrar ninguna variante en particular:
...
insert into retail.colores (codigo, nombre, familia_color, hex, orden)
...
-- 2. Darle código corto a lo que quedó desbloqueado. `retail.fn_asignar_codigo_variante`
