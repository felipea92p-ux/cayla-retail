...
-- Materia prima del Taller"). Decisiones de este cambio en ADR-0074.
--
-- Qué hace:
...
--     alcance de este cambio (ver ADR-0074).
...
-- Verificado contra el Postgres local (2026-09-17, ver ADR-0074): SIN este
...
begin
  ...
  -- columna propia para packaging en producciones, ver ADR-0074). Solo se
