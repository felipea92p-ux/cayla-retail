-- ============================================================================
-- 0051 — `conteo_crear_variante` acepta "sin color" como lo manda un formulario
--
-- QUÉ ARREGLA
...
--   lo demás queda byte por byte como en `0048_conteos.sql`.
-- ============================================================================
...
begin
  ...
  if v_variante_id is null then
    v_codigo := fn_componer_codigo_variante(v_base, v_color_id, p_talla);
