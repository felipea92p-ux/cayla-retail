-- ============================================================================
-- 20260923180400_compras_mi_parte.sql — CAYLA V2 · ADR-0151 (F3-b: la parte de una tienda que NO gestiona la factura)
--
...
comment on function retail.fn_mi_parte_de_compra(uuid) is
  'ADR-0151 (F3-b). El detalle de MI parte en una factura: cabecera sin montos de la factura, mis partes (total, pagado, saldo), mis líneas con solo mis unidades y los pagos de mis tiendas. Falla si ninguna de mis tiendas tiene parte.';
