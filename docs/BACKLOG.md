...
- [ ] Solo si un rango supera 1,000 ventas (hoy no): RPC de agregados + migración (requiere OK). **Decisiones de negocio resueltas el 2026-09-21** (ADR-0144): cada quien ve su tienda y el líder todas; no se incluyen ventas de antes del ERP.
