...
## 🎯 Compras: cada tienda compra, ve y paga lo suyo (2026-09-21, ADR-0151) — ACEPTADO, F1 en construcción local
...
- [ ] **F3–F7:** registrar con tienda gestora (y abrir al comprador SU parte de las repartidas) → pagar por tienda → pantallas → notas de crédito → resultado por tienda.
