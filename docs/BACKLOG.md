...
## 🎯 Nota de venta en el Punto de venta (2026-09-22, ADR-0164) — hecho y verificado en local; falta pegar 1 migración
...
- [ ] **Pegar la migración en producción** — cambio de esquema, **necesita OK de Felipe**. Crea NV01 (TRU), NV02 (AQP) y NV03 (LIM) por nombre.
