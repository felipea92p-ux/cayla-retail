...
- [ ] **F1 construida, POR PEGAR:** migración `20260924210000_configuracion_meta_y_fondo_por_campana.sql` en producción **antes** de publicar la web (Configuración y la meta de Caja/Inicio llaman funciones nuevas; `cerrar_caja` no cambia). Después: cargar las metas por día y el fondo de cada tienda en Configuración, y refrescar el diccionario (`pnpm datos:generar:produccion`).
