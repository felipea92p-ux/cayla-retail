...
cerró V2. Se cerró D-22 de verdad (ADR-0071): TRUNCATE directo o en cascada, modo réplica,
...
- [ ] **ALTO · El ajuste de inventario no tiene aprobación ni tope.** Los 9 Líderes ajustan
      cualquier sede, y los 16 colaboradores de tienda (alta del 16-sep) ajustan la suya sin
      que nadie lo revise. Candidato al mecanismo proponer/aprobar de colores (ADR-0070).
