...
- **Siguiente, a decidir: el catálogo completo se lee en cada visita de 8 pantallas** (Vender, Apartados, Cambios, Recibir, Compras ▸ Nueva, Conteo, Ingreso sin comprobante, Proformas): guardarlo entre visitas (caché del servidor, invalidada al editar catálogo o precios) o adelgazarlo por pantalla.
