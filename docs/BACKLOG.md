...
- [ ] **Producción está en el tope de 6 hijas** (líder parado en el Taller): F6 Resumen y F7 Eficiencia obligan a regrupar. **Quien agregue una fila al menú edita `lib/menu.ts`, no `AppShell.tsx`** (cómo, en el ADR-0144).
