...
- [ ] Mientras #412 no se publique, la caja vieja no muestra el argumento entre 15 y 20 %: esa venta se rechaza al cobrar, y la web vieja lo explica con su texto de antes («pasa el 20 %»). Se cierra al fusionar.
