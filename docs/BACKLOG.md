...
## 🎯 Paleta oficial «CAYLA Dynamic» + rediseño visual de Inventario (2026-09-22, ADR-0167) — hecho, SIN migraciones; falta verlo con clics reales
...
- [ ] Decisiones abiertas de la guía (ADR-0167, «Lo que NO se hizo»): modo oscuro, pasar la caja hueso a todos los formularios, botones de modal sin versalitas y la curva `ease-salida` frente a `--ease-cayla`.
