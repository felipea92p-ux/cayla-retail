...
- [x] **Fase 2 — demanda** (solo tablas temporales): 7.003 boletas, 11.004 prendas, S/ 962.230 (el plan decía ≈ S/ 900.000; +7 %). Ensayada; producción intacta.
- [ ] Fase 3 inventario inicial + abastecimiento (compras, traslados) · Fase 4 ventas + caja + comprobantes · Fase 5 postventa + gastos + Taller · Fase 6 cierre (`stock` de las variantes nuevas) · Fase 7 ensayo completo + prueba de reversibilidad. **Una fase por turno; Felipe da el OK entre cada una.**
