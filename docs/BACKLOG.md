...
## 🎯 Modo sin conexión para agregar productos (2026-09-25, ADR-0209) — solo web, sin migración
...
- [x] **Huecos cerrados (ADR-0209 «(c)»):** error pasajero del servidor se reintenta (tope 10), contador global de pendientes, pregunta al salir con algo pendiente, el alta avisa qué necesita internet, lector QR precargado (era lo único que se cargaba al usarse).
