...
## 🎯 «¿No será un proveedor que ya tienes?» (2026-09-25, ADR-0109 act. (b) y (c)) — solo web, sin migración; (b) en la rama `claude/proveedor-parecido-aviso` (PR #450), (c) en `claude/gasto-proveedor-parecido`
