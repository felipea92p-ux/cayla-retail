...
- [x] **Editar y eliminar cuentas (2026-09-25, pedido de Felipe; ADR-0195 «Actualización 2026-09-25»), EN PRODUCCIÓN (verificada en la base, 2026-09-25):** migración `20260925210000` (UNA ejecución, solo funciones; las 5 funciones con la misma huella que el repo y sus permisos; la ventana lee bien la BCP real: usada, no se elimina, saldo corregible). Nombre y número siempre; tipo mientras nadie la usó; saldo inicial sin conciliación vigente y con su mes abierto; una cuenta sin uso se elimina de verdad, una usada se archiva. Suite `pnpm pruebas:editar-cuentas` (39 casos).
