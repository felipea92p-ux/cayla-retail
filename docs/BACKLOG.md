...
## 🔒 Cuarentena no sale hacia la clienta (2026-09-23, PL-78) — construido, SIN pegar en producción
...
- [ ] **Pegar en producción** (OK puntual, PL-87): sonda antes (0 salidas desde Cuarentena, disparadores de `movimientos` = 4), pegar, después (5 disparadores, el nuevo `tgenabled = 'O'`, ACL de la función sin `authenticated`).
