...
- [ ] Falta el revisor de «pantallas» de esa misma revisión (se interrumpió por un choque de infraestructura, no por hallazgos); relanzado, en curso.
- [ ] Fase 4 ventas + caja + comprobantes · Fase 5 postventa + gastos + Taller · Fase 6 cierre (`stock` de las variantes nuevas, con filas en 0) · Fase 7 ensayo completo + prueba de reversibilidad.
