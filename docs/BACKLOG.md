...
- [x] **Apartados con la guía oficial (2026-09-22, ADR-0173):** tablero como portada (cabecera, franjas, 4 cifras, lista agrupada, nota), «+ Nuevo apartado» abre la hoja de Apartar de siempre y Entregar sale en modal desde la fila. Demo: `docs/maquetas/apartados-rediseno-2026-09/demo.html`. Verificado con los componentes reales y datos de muestra (sin base local).
