...
- [x] **`devolver_proveedor` deja de desaparecer** — entra a `cuarentena` igual que Dañado,
      ...
      `20260917210000_devolver_proveedor_entra_a_cuarentena.sql`. Verificado con
...
- [x] **`proveedores` gana `rubro`/`plazo_credito_dias`/`forma_pago_preferida`** —
      `20260917220000_proveedores_rubro_plazo_forma_pago.sql`. `rubro` a propósito sin
...
- [x] **Dos RPC de métricas, nunca sumadas: `fn_proveedor_metricas_compras` /
      `fn_proveedor_metricas_insumos`** — `20260917230000_proveedor_metricas_compras_e_insumos.sql`.
...
- [x] **Los indicadores del detalle también en la lista, y solo para líder — corrección
      angosta de D-27** (`20260917240000_proveedores_lista_indicadores_y_candado_sede.sql`).
