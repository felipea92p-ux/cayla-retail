...
## 🎯 Fotos de prenda sin fondo y del mismo tamaño (2026-09-26, ADR-0220) — solo web, sin migración; rama `claude/fotos-fondo-blanco`
...
- [ ] Si MODNet muerde demasiadas prendas (entrenado con personas), el reemplazo medido es Photoroom (US$0.02/foto), que se enchufa en `lib/preparar-foto.ts`: ver ADR-0220, «Descarté».
