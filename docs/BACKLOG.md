...
- [ ] **F2a construida, POR PEGAR (2026-09-24):** primero `20260924235000` (plan de cuentas y categorías, una ejecución). Después `20260924235100` en **seis ejecuciones**: 1 compras, 2 compra_pagos, 3 la parte de cada tienda, 4 compras_resumen, 5 el `gastos` de antes, 6 lo nuevo. Van **antes** de publicar la web: Gastos y Por pagar llaman funciones nuevas. Después: refrescar el diccionario. Verificar con clics como tienda con el módulo Gastos (hoy solo con el líder en local).
...
- [ ] **Siguen:** F2b (activos fijos con su depreciación y gastos fijos del mes que el sistema propone), F3 (cuentas de dinero sellando la cuenta en las 22 situaciones), F4…F10.
