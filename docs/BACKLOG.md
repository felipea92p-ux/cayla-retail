...
## 🎯 Catálogo ▸ Marcas: «Eliminar» (2026-09-26, ADR-0216) — migración `20260926200000` EN PRODUCCIÓN (aplicada 2026-09-26, verificada por efectos); web en PR
...
- [ ] Ninguna pantalla resuelve el `marca_id` del historial de un producto a un nombre (ver ADR-0216, «Lo que no deja rastro»): si Felipe quiere ver «cambió de marca X a Y» en la ficha, es una tarea aparte.
