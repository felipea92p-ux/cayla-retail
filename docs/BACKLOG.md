...
## 🎯 Compras por tienda: cada tienda ve y paga lo suyo (2026-09-23, ADR-0179 — nació como 0145/0150/0151) — 5 migraciones EN PRODUCCIÓN (Felipe, 2026-09-23; verificadas en solo lectura), falta pegar `20260923180500`
...
- [ ] **Pegar `20260923180500_compras_comprador_firma_con_actor.sql`** (solo recrea `agregar_comprador_de_tienda` con la firma en variable; sin él, volver a pegar `20260923100000` aborta). Después: refrescar el volcado y `pnpm datos:generar:produccion`.
