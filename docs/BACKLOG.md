...
- [ ] **Editar y eliminar cuentas (2026-09-25, pedido de Felipe; ADR-0195 «Actualización 2026-09-25»), POR PEGAR:** migración `20260925210000` (UNA ejecución, solo funciones). Nombre y número siempre; tipo mientras nadie la usó; saldo inicial sin conciliación vigente y con su mes abierto; una cuenta sin uso se elimina de verdad, una usada se archiva. Suite `pnpm pruebas:editar-cuentas` (39 casos).
