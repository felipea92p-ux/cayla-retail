...
## 🎯 Cambios: flujo guiado, motivo y estado de la prenda que vuelve (2026-09-18, ADR-0121)
...
tiene de verdad — detalle y descartes en ADR-0121.
...
- [x] **Números de ADR y de migración** (2026-09-19, al fusionar con `main`): los de Cambios,
      Devoluciones y Atelier pasaron de 0104/0105/0106 a **0121/0122/0123** (main ya usaba esos
      números) y la migración de `20260918150000` a `20260919000100` (esa hora la ocupa
