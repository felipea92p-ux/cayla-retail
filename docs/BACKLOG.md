...
## 🩹 Los combos dentro de un modal tardaban hasta 1 s en abrirse (2026-09-26, ADR-0211 act. b) — solo web, sin migración; rama `claude/combo-boxes-performance-8fc779`
