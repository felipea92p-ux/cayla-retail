...
## 🎯 Compras: cada tienda compra, ve y paga lo suyo (2026-09-21, ADR-0151) — ACEPTADO, F1–F4 en local
...
- [ ] **F3-b — pendiente, no bloquea:** una vista para que el comprador de una tienda con parte (pero no gestora) vea SOLO su parte de una factura repartida. Hoy no ve nada de esas facturas.
...
- [ ] **F5–F7:** pantallas (incluye Por pagar por tienda) → notas de crédito por tienda (D5, resta de `fn_saldo_de_tienda`) → resultado por tienda.
