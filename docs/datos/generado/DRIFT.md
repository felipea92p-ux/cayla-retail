...
> Comparadas 78 llamadas de `apps/web` contra 128 funciones del schema `retail` en producción.
...
- `actualizar_proveedor` · `apps/web/components/ProveedoresPanel.tsx:354` — el objeto se arma con «...», no se puede leer entero
- `registrar_proveedor` · `apps/web/components/ProveedoresPanel.tsx:358` — los parámetros no van escritos ahí mismo
...
- `listar_compras` · `apps/web/lib/compras.ts:154` — el objeto se arma con «...», no se puede leer entero
