...
> Comparadas 102 llamadas de `apps/web` contra 168 funciones del schema `retail` en producción.
...
- `registrar_pago_compras` · `apps/web/components/PagoJuntosModal.tsx:126` — el objeto se arma con «...», no se puede leer entero
