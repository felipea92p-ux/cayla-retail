...
- **D-47** — Inventario de insumos completo. Parcial: el catálogo y la recepción
  existen en producción (sin `.sql` en git — hueco 2); el consumo real todavía no
  alimenta el costo de la corrida.
