...
las decisiones completas en **ADR-0074**. **Lo único que falta construir de verdad es
...
ADR-0074, "Reconciliación con la otra sesión". **Corrección de nombres, todavía
válida:** la
