...
- `/productos/marcas` (Catálogo ▸ Marcas, módulo `atributos`) → `page.tsx` lee `marcas`, `proveedores`,
  ...
  (`20260926210000`, ADR-0217; solo si ningún producto, de cualquier estado, la tiene; regla pura
