...
## 2026-09-26 (Cambios conectado con las pantallas vecinas — ADR-0229)
Felipe pidió que Cambios trabajara de la mano con las pantallas nuevas, en computadora y en celular. Hubo análisis, investigación de 6 sistemas (Shopify, Lightspeed, Square, Bsale, Loop, Zara), un demo comparativo (`docs/maquetas/cambios-mejoras-2026-09/`) y la implementación, solo web, sin migración. Cuando la talla no está, el paso 3 ofrece pedirla a otra sede (traslado prellenado), apartarla cuando llegue, anotar que no había o pasar a devolución. En el celular, un botón fijo abre la cámara y busca la compra por la etiqueta o el QR de la boleta. Al terminar, una hoja con el ticket (WhatsApp, imprimir, seguir vendiendo). El plazo dice «Quedan N días», en ámbar los últimos 3.
Felipe se lleva: (1) **conectar no es duplicar**: Cambios no traslada ni aparta, lleva a la pantalla que ya lo hace con lo elegido puesto. (2) **Un enlace que no respeta tu rol es peor que ninguno**: el traslado prellenado solo sirve al líder, así que la integrante ve «pídeselo a tu líder». (3) **Apartar «cuando llegue» no necesitó un estado nuevo**: se aparta al llegar y se cambia al volver.
