...
Sin resolver: la migración `20260922100000` no está pegada en producción y su prueba SQL (`pnpm pruebas:colaboradores-endurecimiento --en-seco`) no se pudo correr sin Docker; quedan las tareas #3 (historial de accesos), #6 (cambiar ubicación), #10–#12 y la decisión sobre cuáles de los 9 líderes deben serlo.
