...
Sin resolver: pegar las dos migraciones y fusionar (con OK de Felipe); probar «Cobrar» y «Regularizar» con clics en una tienda real, porque la base local no tiene la asistencia de Dynamic.
