...
Sin resolver: el PR; las decisiones de Felipe sobre R-38, R-20, más de 35% y Audaces; `AGENTS.md`, `config.toml` y el hook de graphify siguen contradiciendo a CLAUDE.md (ver BACKLOG).
