...
## 2026-09-25 (Modo sin conexión: huecos cerrados — ADR-0209 «(c)»)
...
## 2026-09-25 (Alta de producto sin red, combo con memoria y service worker — ADR-0209 «(b)»)
...
## 2026-09-25 (Recibir mercadería sin conexión — paso 1 del modo sin conexión para agregar productos, ADR-0209)
