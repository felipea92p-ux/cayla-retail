...
## 2026-09-26 (Existencias: los botones de la cabecera a la derecha — ADR-0220, actualización de la tarde)
Pediste mover «Bajar al piso» y «+ Nuevo traslado» a la derecha, donde la cabecera tenía espacio. La cabecera compartida decide ahora sola dónde van las acciones: a la derecha si está libre, bajo la frase si ahí ya están las cifras o el reloj (Caja pasa las suyas por la misma ranura y no cambió ni un píxel: HTML idéntico). Lo mismo en Traslados («+ Nuevo traslado») y en «Seguir contando» del detalle de un conteo, para que el mismo botón no viva en dos lugares del módulo. A 1440 px la cabecera de Existencias baja de 184 a 130 px; por debajo de ~1180 px de ventana vuelve sola a la de antes.
Felipe se lleva: (1) **una decisión descartada por una razón que no aplica se revisa, no se defiende**: esta mañana se descartó «acciones a la derecha» porque en Ventas la derecha es de las cifras o del reloj, y Existencias no tiene ni lo uno ni lo otro. (2) **Que decida la pieza compartida, no cada pantalla**: con la ranura `acciones`, una pantalla nueva no puede poner sus botones en el lugar equivocado. (3) **Un diseño que se degrada solo vale más que uno que exige un ancho**: en una laptop chica los botones vuelven a su fila sin que nadie haga nada.
