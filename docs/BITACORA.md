...
Sin resolver: pegar la migración en producción y refrescar dos líneas del volcado; las cuatro cifras de arriba de Comprobantes y Por pagar siguen siendo las de todo (como con el filtro de proveedor).
