...
Sin resolver: confirmar o pegar la `0000` y la `0300`, y después la `150000`; encender «Bajada al piso» en los roles; el candado de `mover_interno` (entre el bloque 2 y el 3); la marca de «retirada de la venta», que también debe apagar Análisis y la consulta 05 (bloque 3); netear los retiros posteriores a una bajada (bloque 3); y el mismo hueco de sede en «Apartar» y «Ajustar».
