...
que el choque de ADR-0051 de la ronda anterior. Renumerado otra vez a **0062** al
fusionar `DiegoN` con `main` para el PR #47 (2026-09-16): toda la serie 0051-0056 de
`DiegoN` (historial-de-producto, producción-del-taller, fotos, muestra-de-color, esta)
chocaba con la propia serie 0051-0057 de `main` (Vender+Caja); ganó la de `main` por
estar ya asentada primero, y las de `DiegoN` corrieron a 0058-0062.
